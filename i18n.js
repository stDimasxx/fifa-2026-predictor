...
(function () {
  const I18N = {
    uk: {
      ...
      pts_legend: '3 = точний · 2 = різниця · 1 = результат · 0 = промах · плей-оф: +1 за вірного фаворита при нічиї',
      ...
      round_G1: '1-й тур групи (пропущено)', round_G2: '2-й тур групи', round_G3: '3-й тур групи',
      ...
      alert_fill_missing: 'Заповни ще {n} матч(ів) у цьому турі!',
      alert_round_skipped: 'Тур «{round}» пропущено організатором — очки не рахуються.',
      seal_skipped_note: 'пропущено · 0 оч.',
      round_skipped_pts: '0 оч. (пропущено)',
      alert_groups_first: 'Спочатку закрий усі 3 тури групового етапу!',
      ...
      name_locked_title: 'Ім\'я зафіксовано в купоні. «Скинувати все» — щоб змінити.', btn_close: '✕ Закрити', scroll_top: 'Вгору',
    ...
    en: {
      ...
      pts_legend: '3 = exact · 2 = goal diff · 1 = outcome · 0 = miss · KO: +1 for correct advancer on a draw',
      ...
      round_G1: 'Group — Round 1 (skipped)', round_G2: 'Group — Round 2', round_G3: 'Group — Round 3',
      ...
      alert_fill_missing: 'Fill {n} more match(es) in this round!',
      alert_round_skipped: 'Round «{round}» was skipped by the organizer — no points.',
      seal_skipped_note: 'skipped · 0 pts',
      round_skipped_pts: '0 pts (skipped)',
      alert_groups_first: 'Seal all 3 group rounds first!',
      ...
      name_locked_title: 'Name locked in coupon. Use «Reset all» to change.', btn_close: '✕ Close', scroll_top: 'Back to top',
    ...
    pl: {
      ...
      pts_legend: '3 = dokładny · 2 = różnica bramek · 1 = wynik · 0 = pudło · puchar: +1 za trafionego awansującego przy remisie',
      ...
      round_G1: 'Faza grupowa — kolejka 1 (pominięta)', round_G2: 'Faza grupowa — kolejka 2', round_G3: 'Faza grupowa — kolejka 3',
      ...
      alert_fill_missing: 'Wypełnij jeszcze {n} mecz(y) w tej turze!',
      alert_round_skipped: 'Tura «{round}» pominięta przez organizatora — bez punktów.',
      seal_skipped_note: 'pominięta · 0 pkt',
      round_skipped_pts: '0 pkt (pominięta)',
      alert_groups_first: 'Najpierw zamknij wszystkie 3 tury grupowe!',
      ...
      name_locked_title: 'Imię zablokowane w kuponie. «Reset» — aby zmienić.', btn_close: '✕ Zamknij', scroll_top: 'Do góry',
  ...
  const HOWTO = {
    uk: [
      { t: 'Мета', b: '<p>Заповни прогнози на ЧС-2026, закривай тури й змагайся з друзями. Очки: <strong>3</strong> точний · <strong>2</strong> різниця · <strong>1</strong> результат · <strong>0</strong> промах. У плей-оф при нічиї — ще <strong>+1</strong>, якщо вгадав хто проходить (ставиш переможця одразу — бонусу немає).</p>' },
      ...
      { t: 'Прогнози', b: '<p>Вкладки <strong>Групи</strong> / <strong>Плей-оф</strong>. Редагується лише <em>поточний тур</em>. У плей-оф при нічиї обери хто проходить далі — за основний час очки як у групі, плюс <strong>+1</strong> за вірний вибір. Прогноз блокується за <strong>10 хв</strong> до старту (Варшава).</p>' },
    ...
    en: [
      { t: 'Goal', b: '<p>Predict World Cup 2026 matches, seal rounds, compete with friends. Scoring: <strong>3</strong> exact · <strong>2</strong> goal diff · <strong>1</strong> outcome · <strong>0</strong> miss. In KO, a draw pick earns <strong>+1</strong> more if you name the correct advancer (no bonus if you pick a winner outright).</p>' },
      ...
      { t: 'Picks', b: '<p><strong>Groups</strong> / <strong>Knockout</strong> tabs. Only the <em>current round</em> is editable. On a KO draw, pick who advances — regular-time points as in groups, plus <strong>+1</strong> for the right advancer. Picks lock <strong>10 min</strong> before kickoff (Warsaw).</p>' },
    ...
    pl: [
      { t: 'Cel', b: '<p>Typuj MŚ 2026, zamykaj tury i rywalizuj. Punkty: <strong>3</strong> dokładnie · <strong>2</strong> różnica · <strong>1</strong> wynik · <strong>0</strong> pudło. W pucharze przy remisie — dodatkowe <strong>+1</strong> za trafionego awansującego (bez bonusu, gdy od razu typujesz zwycięzcę).</p>' },
      ...
      { t: 'Typy', b: '<p>Zakładki <strong>Grupy</strong> / <strong>Puchar</strong>. Edytowalna tylko <em>bieżąca tura</em>. Przy remisie w pucharze wybierz kto awansuje — punkty za regulaminowy czas jak w grupie, plus <strong>+1</strong> za trafiony wybór. Typ zamyka się <strong>10 min</strong> przed startem (Warszawa).</p>' },
